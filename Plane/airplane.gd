...
var min_flight_speed: int = 10 # Can't fly below this speed
var max_flight_speed: int = 20 # Maximum airspeed
...
var throttle_delta: int = 30 # Throttle change speed
var acceleration: float = 6.0 # Acceleration/deceleration
